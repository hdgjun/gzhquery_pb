...
<body class="easyui-layout">
	<div region="north" border="true" class="cs-north">
		<div class="cs-north-bg">
			<div class="cs-north-logo">人民银行冠字号核查系统</div>
			<ul class="ui-skin-nav">
				<li class="li-skinitem" title="gray"><span class="gray"
					rel="gray"></span>
				</li>
				<li class="li-skinitem" title="pepper-grinder"><span
					class="pepper-grinder" rel="pepper-grinder"></span>
				</li>
				<li class="li-skinitem" title="blue"><span class="blue"
					rel="blue"></span>
				</li>
				<li class="li-skinitem" title="cupertino"><span
					class="cupertino" rel="cupertino"></span>
				</li>
				<li class="li-skinitem" title="dark-hive"><span
					class="dark-hive" rel="dark-hive"></span>
				</li>
				<li class="li-skinitem" title="sunny"><span class="sunny"
					rel="sunny"></span>
				</li>
			</ul>
		</div>
	...
	<div region="west" border="true" split="true" title="菜单" class="cs-west">
		<div class="easyui-accordion" fit="true" border="false">
			<div title="系统功能">
				...
				<a href="javascript:void(0);" src="${pageContext.request.contextPath}/portal/gzhquery.jsp"
					class="cs-navi-tab">人民币冠字号信息</a>
				</li>
				<li style="margin: 15px">
				<a href="javascript:void(0);" src="${pageContext.request.contextPath}/portal/ATMgzhquery.jsp"
					class="cs-navi-tab">ATM冠字号信息查询</a>
				</li>
				<li style="margin: 15px">
				<a href="javascript:void(0);" src="${pageContext.request.contextPath}/portal/ATMgzhquery.jsp"
					class="cs-navi-tab">智能终端信息查询</a>
				</li>
			</div>
		</div>
	</div>
	<div id="mainPanle" region="center" border="true" border="false">
		<div id="tabs" class="easyui-tabs" fit="true" border="false">
			<div title="人民币冠字号结果查询">
				...
				<iframe scrolling="auto" frameborder="0"  src="${pageContext.request.contextPath}/portal/index.jsp" style="width:100%;height:100%;"></iframe>
			</div>
		</div>
	</div>
	<div region="south" border="false" class="cs-south">版权所有@Finder</div>
