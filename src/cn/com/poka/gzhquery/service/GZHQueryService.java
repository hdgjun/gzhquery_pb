...
public class GZHQueryService {
	...
	public GZHQueryService() throws Exception{
		try {
			...
			bankInfoDao = DaoFactory.newInstance().getBankInfoDao();
		} catch (Exception e) {
			throw e;
		}
	}
	...
	public List<BankInfo> getBankInfo(String bankNo) throws Exception{
		return bankInfoDao.findBankInfo(bankNo);
	}
	
	public List<BankInfo> getBankInfoList() throws Exception{
		return bankInfoDao.findBankInfoList();
	}
}
