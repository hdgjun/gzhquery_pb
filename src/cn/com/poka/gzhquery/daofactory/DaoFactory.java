...
public class DaoFactory {
	...
	public BankInfoDao getBankInfoDao() throws Exception{
		String bankIndoDaoClass = props.getProperty("bankInfoDaoClass");
		BankInfoDao bankInfoDao = (BankInfoDao) Class.forName(bankIndoDaoClass).newInstance();
		return bankInfoDao;
	}
}
